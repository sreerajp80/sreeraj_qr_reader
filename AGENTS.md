...
| Package / org id | `in.sreerajp.qr_reader`                                                                         |
| Flutter SDK      | `>=3.44.8`                                                                                      |
...
| ------ | --------------------------- | ------------------- | ------------------------------------------- |
| `dev`  | `in.sreerajp.qr_reader.dev` | QR Reader Dev       | Debug keystore (automatic)                  |
| `prod` | `in.sreerajp.qr_reader`     | Sreeraj P QR Reader | Release keystore (`android/key.properties`) |
